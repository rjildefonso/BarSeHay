...
<head>
    ...
    <title>Barretto Senior High School Grade System</title>
    ...
    <div id="loginScreen" class="login-container flex items-center justify-center p-4">
        <div class="bg-white rounded-xl shadow-2xl p-6 sm:p-8 max-w-md w-full mx-auto">
            ...
            <div class="text-center mb-6 sm:mb-8">
                ...
                <h1 class="text-xl sm:text-xl font-bold text-foreground">Barretto Senior High School</h1>
    ...
    <div id="dashboardScreen" class="hidden min-h-screen">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
            ...
            <div class="mt-6 sm:mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div class="bg-white rounded-xl p-4 sm:p-6 border border-border">
                    <h3 class="font-medium text-foreground mb-3 sm:mb-4 text-sm sm:text-base">Teachers Comments</h3>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const students = {
                '2021001': { 
                    ...
                    name: 'Jhoaila Navarro',
                    grades: [
                        { subject: 'Filipino sa Piling Larang', teacher: 'Mr. Banagan', grade: 75 },
                        { subject: 'Understanding Culture, Society and Politics', teacher: 'Ms. Echon', grade: 65 },
                        { subject: 'Contact Center Services', teacher: 'Ms. Balois', grade: 75 },
                        { subject: 'English for Academics & Professional Purporses', teacher: 'Mr. Manuel', grade: 75 },
                        { subject: 'Practical Research 2', teacher: 'Mr. Biag', grade: 75 },
                        { subject: 'Personal Development', teacher: 'Ms. Ortiz', grade: 75 },
                        { subject: 'Physical Education and Health 3', teacher: 'Ms. Damaso', grade: 75 }
                    ]
                },
                '2021002': { 
                    password: 'mypassword', 
                    name: 'RJ ILDEFONSO',
                    grades: [
                        { subject: 'Filipino sa Piling Larang', teacher: 'Mr. Banagan', grade: 90 },
                        { subject: 'Understanding Culture, Society and Politics', teacher: 'Ms. Echon', grade: 90 },
                        { subject: 'Contact Center Services', teacher: 'Ms. Balois', grade: 87 },
                        { subject: 'English for Academics & Professional Purporses', teacher: 'Mr. Manuel', grade: 98 },
                        { subject: 'Practical Research 2', teacher: 'Mr. Biag', grade: 98 },
                        { subject: 'Personal Development', teacher: 'Ms. Ortiz', grade: 98 },
                        { subject: 'Physical Education and Health 3', teacher: 'Ms. Damaso', grade: 98 }
                    ]
                },
                  ...
                  '20213': { 
                   ...
                   '2021005': { 
                    password: 'tintin', 
                    name: 'Kristine Alonsabe',
                    grades: [
                        { subject: 'Filipino sa Piling Larang', teacher: 'Mr. Banagan', grade: 75 },
                        { subject: 'Understanding Culture, Society and Politics', teacher: 'Ms. Echon', grade: 90 },
                        { subject: 'Contact Center Services', teacher: 'Ms. Balois', grade: 90 },
                        { subject: 'English for Academics & Professional Purporses', teacher: 'Mr. Manuel', grade: 100 },
                        { subject: 'Practical Research 2', teacher: 'Mr. Biag', grade: 90 },
                        { subject: 'Personal Development', teacher: 'Ms. Ortiz', grade: 90 },
